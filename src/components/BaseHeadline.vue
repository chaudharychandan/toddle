<template>
  <div
    ...
    class="t-headline"
    v-bind:style="{color: color, height : height + 'px'}">
    ...
    <h5 v-else-if="size === 'xs'" class="body-2 mb-2">{{ title }}</h5>
    <h4 v-else class="subheading mb-2">{{ title }}</h4>
    <div class="grey--text">
...
.t-headline{
  .headline, .title, .subheading, .body-2 {
    font-weight: 600;
    color: inherit;
  }
}
